export class FiltrodeMantenimientoGetAdapter {
    ...
    constructor(classroom: { classroom_id: string, other: number, teaching_material: number, technological_mean: number }, total_maintenances_after_two_years: number) {
        ...
        this.total_maintenances_after_two_years = total_maintenances_after_two_years;
